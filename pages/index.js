        ...
        <div className="space-y-24">
            ...
            <div>
                ...
                <p className="max-w-4xl mt-5 text-lg md:text-xl text-gray-500 dark:text-gray-400">
                    I'm a first-year computer science student at Brown University, a frontend software engineering
                    (STEP) intern at
                    Google, and an entrepreneurial full-stack developer with a passion for building accessible and
                    useful tools for
                    education.
                </p>
            </div>
